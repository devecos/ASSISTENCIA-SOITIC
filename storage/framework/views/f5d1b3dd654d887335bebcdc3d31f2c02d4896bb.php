    <div class="blog_post_style2 blog_single_div">
        ...
        <div class="blog_post_style2_content wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
            ...
            <div class="blog_author_data"><a href="#"><img src="https://via.placeholder.com/34x34" class="img-fluid"
...
<?php /**PATH C:\work\repositorios\arquivoteca\resources\views/pages/blog_content.blade.php ENDPATH**/ ?>