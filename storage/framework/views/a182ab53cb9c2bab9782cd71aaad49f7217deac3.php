            ...
            <div class="row mt-5">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="blog_breadcrumb_div text-left">
                        <h2 class="text-white">Blog Arquivoteca</h2>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ECOS\Documents\GitHub\ARQUIVOTECA-ECOS\resources\views/pages/blog_cat.blade.php ENDPATH**/ ?>