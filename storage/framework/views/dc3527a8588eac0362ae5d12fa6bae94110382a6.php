<section id="footer"></section>
                ...
                <div class="container" style="padding-top:20px">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row align-items-center justify-content-end mt-3">
                                    <div
                                        ...
                                        <img src="assets/img/Logotipo ARQUIVOTECA 2016_cv2.png"
                                    ...
                                    <div
                                        ...
                                        <img src="assets/img/Horus-Logo.png" class="img-fluid horus-logo-footer">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-center text-white py-4">
                        <small>Arquivoteca - <?php echo e(Carbon\Carbon::now()->format('Y')); ?>. Todos os direitos reservados ® | Desenvolvido por <a
                                class="text-white ts-font-weight__bold" href="agenciaecos.com"
        ...
        <!--end #footer--><?php /**PATH C:\work\repositorios\arquivoteca\resources\views/layouts/footer.blade.php ENDPATH**/ ?>