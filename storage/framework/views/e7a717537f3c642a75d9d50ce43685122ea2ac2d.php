...
<main id="ts-content">
    ...
    <section class="header1 cid-rJdLcUH3VL" data-bg-video="https://www.youtube.com/watch?v=AHoJ9HO4ZGM">
        ...
        <div class="container mbr-black">
            ...
            <h5 class="mbr-text pb-2 mbr-fonts-style text-white text-center">Com nosso trabalho, sobra mais tempo e
                                        ...
                                        <div class="row d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="pt-1 pr-3 pl-3">
                                                <a class="box-item-title mbr-fonts-style text-white ts-h7 ts-font-weight__semibold"
                                                    href="<?php echo e(route('servico', ['id' => $servico->id_texto, 'nome' => str_slug($servico->titulo)])); ?>" style="line-height: 18px!important;"><?php echo e($servico->titulo); ?></a>
                                            </div>
                                        </div>
                                    </a>
                                </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/pages/home.blade.php ENDPATH**/ ?>