                                    ...
                                    <li>
                                        ...
                                        <div class="blog_news">
                                            <div class="blog_news_title">
                                                <h4><a href="<?php echo e(route('blog', ['id' => $posts->id_texto, 'nome' => str_slug($posts->titulo)])); ?>"><?php echo e($posts->titulo); ?></a></h4>
                                                <p><?php echo e(Carbon\Carbon::parse($posts->created_at)->format('d M, Y')); ?></p>
                                                <br>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.base', ['blog_metatags' => $post], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ECOS\Documents\GitHub\ARQUIVOTECA-ECOS\resources\views/pages/blog.blade.php ENDPATH**/ ?>