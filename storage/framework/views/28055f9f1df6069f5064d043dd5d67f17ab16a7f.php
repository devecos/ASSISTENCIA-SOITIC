...
<link rel="stylesheet" href="<?php echo e(asset('assets/font-awesome/css/font-awesome.css')); ?>">
...
<script>
    ...
    $(document).ready(function(event){
        $('body').find("[data-f-id='pbf']").css('display', 'none');
        // event.preventDefault();
    });


</script><?php /**PATH C:\Users\ECOS\Documents\GitHub\ARQUIVOTECA-ECOS\resources\views/layouts/head.blade.php ENDPATH**/ ?>