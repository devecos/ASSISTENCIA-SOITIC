                    ...
                    <div class="row d-flex align-items-center justify-content-center">
                        ...
                        <div class="col-md-5">
                            <div class="ts-story ts-separate-bg-element"
                                style="background:linear-gradient(0deg, rgba(255, 255, 255, 0), rgba(162, 153, 159, 0.12)), url(https://s3-us-west-2.amazonaws.com/fasow/39064/imagens/<?php echo e($post->imagem); ?>);background-size:cover;background-position:center">
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/pages/blog_cat.blade.php ENDPATH**/ ?>