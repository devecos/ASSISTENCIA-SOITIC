...
<div class="col-md-4 col-lg-3">
    <div class="ts-story ts-separate-bg-element" style="background:linear-gradient(0deg, rgba(255, 255, 255, 0.55), rgba(162, 153, 159, 0.3)), url(https://s3-us-west-2.amazonaws.com/fasow/39064/imagens/<?php echo e($post->imagem); ?>);background-size:cover;background-position:center">
...
<?php /**PATH C:\work\repositorios\arquivoteca\resources\views/pages/loadMoreBlog.blade.php ENDPATH**/ ?>